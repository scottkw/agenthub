...
| 150. Shell-Sharing Warning Toggle | v4.0 | 3/3 | Complete   | 2026-06-23 |
...
- [x] 146-05-PLAN.md — Gap closure GAP-146-A: held-cap reuse for "Open in browser" (no second single-use code); WR-01/WR-02/WR-03 fixes
...
- [x] 147-04-PLAN.md — TESTING.md registration (Suite Manifest §2, Traceability §4) + M-14 manual UAT item
...
**Plans**: 1 plan
- [x] 148-01-PLAN.md — tab__chevron button (session-gated, rect-anchored menu open, aria-label "Session menu") + .tab__context-menu light/dark tokenization (D-07) + TabBar vitest + TESTING.md TAB-04 registration (TAB-04)
