...
**Plans**: 5 plans
- [ ] 141-01-PLAN.md — New --hub-text-dim token (both themes) + Wave 0 RED test updates (GroupSidebar ARIA, StatusBar D-11, SessionShareModal S-07 smoke) (RDS-02, RDS-04, CARRY-01, RDS-03)
- [ ] 141-02-PLAN.md — Tokenize sidebar (S-01 Welcome) + tab bar/status bar/terminal (S-03); D-03 fences kept; motion guards (RDS-02, RDS-04)
...
| 141. Redesign Implementation | v4.0 | 0/5 | Not started | - |
