...
- [ ] 120-03-PLAN.md — BreadcrumbBar + FileListPane + FileRow + StatusLine + sortEntries with keyboard nav + ARIA + data-testid taxonomy
- [ ] 120-04-PLAN.md — FileBrowserTab orchestrator + PreviewPane (Text/Markdown/Image/Unsupported/Empty/PermissionDenied/NetworkError) + App.tsx/DaemonManagerPanel/TabBar wiring + webserver SetStaticAppFS production embed
