...
| 163. Read-Only Guest Chat Posting (ROCHAT-01/02, SEC-RO-01) | 0/3 | Planned (3 plans) | — |
...
- [ ] 163-01-PLAN.md — Server: remove RO chat-send gate in hub.HandleChatSend (single source for relay + webserver paths) + delete ErrChatReadOnly + flip Go RO tests + dual-invariant regression guard (RO chats, inject still ErrReadOnly/zero PTY) [ROCHAT-01, ROCHAT-02, SEC-RO-01] [wave 1]
