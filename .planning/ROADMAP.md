...
**Plans:** 4 plans
Plans:
- [ ] 77-01-PLAN.md — Scaffolding: model state, styles, keybindings (r=rename, R=refresh), cmds, help, view, update dispatch + tests
...
| 77. TUI Session Operations | v2.0 | 0/4 | Not started | - |
