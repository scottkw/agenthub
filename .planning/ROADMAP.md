...
**Plans:** 3 plans
Plans:
- [ ] 84-01-PLAN.md — Backend exit detection, exit code capture, auto-close settings API
- [ ] 84-02-PLAN.md — Frontend components (ExitToast, ExitCountdownBanner), App.tsx wiring, TabBar countdown, Settings toggle
