...
- [x] **Phase 5: QR Codes + Status Indicators** - QR code generation, session status heuristics, per-session URL display (gap closure in progress) (completed 2026-03-18)
...
- [ ] 06-02-PLAN.md — GitHub Actions CI matrix with macOS signing/notarization + cross-platform verification
