# Requirements Archive: v1.10 Collapsible Sidebar Navigation
...
- [x] **NAV-01**: User can click Home icon to open the Welcome tab
- [x] **NAV-02**: User can click Remote icon to open the Remote Sessions panel
- [x] **NAV-03**: User can click Sessions icon to open the Daemon Manager panel
- [x] **NAV-04**: User can click New Tab icon to create a new terminal session
- [x] **NAV-05**: User can click Settings icon (pinned to sidebar bottom) to open the Settings panel
...
- [x] **TAB-01**: Tab bar retains session tabs but no longer has action buttons on the right
