...
resolution:
  ...
  deferred: [WR-04]
  deferred_note: "WR-04 (GroupSidebar listbox roving-tabindex / arrow-key model) deferred to follow-up issue scottkw/agenthub#97 — rewrites the ARIA interaction model of a pre-Phase-135 component (built in 131/132); out of accessibility-hardening scope."
