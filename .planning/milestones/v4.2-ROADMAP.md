...
- [x] 174-03-PLAN.md — DEP-02 defer wails/tailscale/checkout via surgical dependabot.yml ignores + close #104/#88/#102
...
- [x] 175-01-PLAN.md — Wave 0: BUG-03 live timed diagnostic (confirm/disprove the app.go:386 deadline)
- [x] 175-02-PLAN.md — Wave 0: test scaffolds — deadline-helper extraction + RED Go tests for BUG-02/BUG-04
- [x] 175-03-PLAN.md — Wave 1: BUG-01 mobile legibility (readability floor + horizontal-scroll fallback)
- [x] 175-04-PLAN.md — Wave 1: BUG-04 lazy live per-hub VT emulator reconnect preamble (both WS sites)
- [x] 175-05-PLAN.md — Wave 1: BUG-03 exit-poll fix (gated on 175-01 diagnosis)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 175-06-PLAN.md — Wave 2: BUG-02 disconnect notice (WS close reason + colorblind-safe banner)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 175-07-PLAN.md — Wave 3: TESTING.md reconciliation (manifest, traceability, M-NN, Category P)
...
- [x] 176-01-PLAN.md — BUG-05 (#124): darwin-guard the role menus + Linux DMABUF env guard in main.go [Wave 1]
- [x] 176-02-PLAN.md — BUG-06 (#123): wrap /app/ route in ws.cspHeaders + TestCSPHeaderStrict_App [Wave 1]
- [x] 176-03-PLAN.md — BUG-07 (#127): live-repro mini-preview first, then fix+test or close-as-already-fixed [Wave 1]
...
- [x] 177-01-PLAN.md — Wire the seam: app.go SessionInfo `FunnelWriteActive` field + ListSessions copy (load-bearing runtime fix); frontend verify-only + optional non-imported models.ts hygiene [Wave 1] (FNL-09)
- [x] 177-02-PLAN.md — Regression guard: genuine Go struct-parity/serialization round-trip test asserting the real app.go JSON (not stub text) + optional App.d.ts contract assertion + TESTING.md reconcile [Wave 2] (FNL-09)
