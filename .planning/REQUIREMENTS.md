...
- [x] **RB-02**: User can select a remote peer session from the panel and open it in the File Browser, completing discover→list→pick end-to-end over the relay loopback the GUI uses
