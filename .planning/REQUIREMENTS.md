...
- [x] **DMGR-01**: Closing the GUI window hides it instead of quitting — daemon and tray icon remain active
...
- [x] **RMTE-01**: Web terminal (browser) displays a status bar showing session name, agent type, host machine name, and connection state
