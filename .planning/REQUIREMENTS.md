...
- [ ] **RMTE-03**: Session metadata from daemon includes machine hostname (`os.Hostname()`) for remote identification

### Branding

- [ ] **BRND-01**: App icon set generated from logomark: .icns (macOS), .ico (Windows), multi-size PNGs (Linux/Wails)
