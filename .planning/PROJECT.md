...
No active milestone — v4.1 shipped 2026-06-29; next is set via `/gsd-new-milestone`. Open next-milestone candidates remain deferred: #93 (deferred #78 Hub fidelity), #49 (split panes), #10 (intersession orchestration), plus the carried v4.1 release follow-up (push `main` to origin → run M-25 clean-box Linux install).
