...
**v4.2 — Funnel Sharing & Polish** (unreleased — in development on the `v4.2-funnel-sharing` branch) — adds one-click public-internet session sharing over Tailscale Funnel, native awaiting-input notifications, and a round of bug fixes and settings polish.
...
- **In-app sharing guide** — A new searchable Help article walks through the Funnel share flow and the contained device-share + ACL alternative.
- **Bug fixes & settings polish** — web-guest plugin hot-swap over the capability-gated SSE stream ([#112](https://github.com/scottkw/agenthub/issues/112)); the footer "Share Session" pill now tracks the Share modal's live state ([#115](https://github.com/scottkw/agenthub/issues/115)); a "Stay on Hub after creating a session" toggle ([#116](https://github.com/scottkw/agenthub/issues/116)); owner-driven "disconnect all viewers" plus accurate remote-only viewer counts ([#117](https://github.com/scottkw/agenthub/issues/117), [#121](https://github.com/scottkw/agenthub/issues/121)); remote tailnet sessions open in an in-app terminal tab instead of an external browser ([#118](https://github.com/scottkw/agenthub/issues/118)); and honest **"Permission Limited"** Tailscale detection on non-admin macOS accounts where the `macsys` status file is unreadable — instead of a misleading "not connected" ([#120](https://github.com/scottkw/agenthub/issues/120)).

Will close [#107](https://github.com/scottkw/agenthub/issues/107), [#110](https://github.com/scottkw/agenthub/issues/110), [#112](https://github.com/scottkw/agenthub/issues/112), [#115](https://github.com/scottkw/agenthub/issues/115), [#116](https://github.com/scottkw/agenthub/issues/116), [#117](https://github.com/scottkw/agenthub/issues/117), [#118](https://github.com/scottkw/agenthub/issues/118), [#120](https://github.com/scottkw/agenthub/issues/120), [#121](https://github.com/scottkw/agenthub/issues/121). _Release notes and download links will be added when v4.2 ships._
