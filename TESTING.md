...
|-------|-------|----------|-------------|--------|
| Go unit/integration | **354** `*_test.go` files | `internal/`, repo root | `go test -race -short ./...` | Daemon API, relay wire framing, capability model, PTY, webserver, files, status, tailnet |
